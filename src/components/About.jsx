...
function About() {
    return (
        <div className="body">
            ...
            <h1>About Us</h1>
            <p>
                Welcome to GlobeTrekker Getaways, your ultimate destination for unforgettable travel experiences and seamless accommodation bookings.
                At GlobeTrekker Getaways, we're passionate about helping travelers discover new destinations, immerse themselves in diverse cultures, and create lasting memories.
                ...
                Whether you're planning a romantic getaway, a family vacation, or a solo adventure, let GlobeTrekker Getaways be your gateway to the world's most captivating destinations.
